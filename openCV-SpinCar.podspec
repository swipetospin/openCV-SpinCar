...
Pod::Spec.new do |s|
  ...
  s.prepare_command = "touch Empty.m && mv ios/opencv2.framework/Versions/A/opencv2.txt ios/opencv2.a && mv ios/opencv2.framework/Versions/A/Headers ios/include"
  ...
  s.libraries    = 'c++', 'stdc++'  
  s.preserve_paths = 'ios/opencv2.a','opencv2.framework'
